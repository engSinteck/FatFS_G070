...
#define ST7735_A0_PORT     LCD_DC_GPIO_Port
...
// A0 pin macros
#define A0_L() HAL_GPIO_WritePin(LCD_DC_GPIO_Port, LCD_DC_Pin, GPIO_PIN_RESET)
#define A0_H() HAL_GPIO_WritePin(LCD_DC_GPIO_Port, LCD_DC_Pin, GPIO_PIN_SET)
